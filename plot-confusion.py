...
pos_labels = map(strip, open(pos_labels_fname).readlines())
parse_labels = map(strip, open(parse_labels_fname).readlines())
...
# zero-out diagonal, i.e. correct labels
...
ax2.set_ylabel("Gold")
ax2.set_xlabel("Parser Inferred Tag")
